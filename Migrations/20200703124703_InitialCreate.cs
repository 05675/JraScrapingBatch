        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Wide1_1Num = table.Column<int>(nullable: true),
                    Wide1_2Num = table.Column<int>(nullable: true),
                    Wide1Re = table.Column<int>(nullable: true),
                    ...
                    Wide2_1Num = table.Column<int>(nullable: true),
                    Wide2_2Num = table.Column<int>(nullable: true),
                    Wide2Re = table.Column<int>(nullable: true),
                    ...
                    Wide3_1Num = table.Column<int>(nullable: true),
                    Wide3_2Num = table.Column<int>(nullable: true),
                    Wide3Re = table.Column<int>(nullable: true),
                    ...
                    Umaren1Num = table.Column<int>(nullable: true),
                    Umaren2Num = table.Column<int>(nullable: true),
                    UmarenRe = table.Column<int>(nullable: true),
                    ...
                    Umatan1Num = table.Column<int>(nullable: true),
                    Umatan2Num = table.Column<int>(nullable: true),
                    UmatanRe = table.Column<int>(nullable: true),
                    ...
                    Sanfuku1Num = table.Column<int>(nullable: true),
                    Sanfuku2Num = table.Column<int>(nullable: true),
                    Sanfuku3Num = table.Column<int>(nullable: true),
                    SanfukuRe = table.Column<int>(nullable: true),
                    ...
                    Santan1Num = table.Column<int>(nullable: true),
                    Santan2Num = table.Column<int>(nullable: true),
                    Santan3Num = table.Column<int>(nullable: true),
                    SantanRe = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Waku = table.Column<int>(nullable: true),
                    ...
                    Trainer = table.Column<string>(nullable: true),
                    Pop = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RaceResults", x => new { x.Date, x.RaceName, x.Num, x.Place });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RaceInfo", x => x.Date);
                    table.ForeignKey(
